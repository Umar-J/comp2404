...
def test(dirname, outof):
	...
	score += run(["./test"], 5, '0', ["All device names found", "All app titles found"]) #this should assign a grade based off the return value only
	...
	score += run(["valgrind","./test"], 5, '2', ["All app titles found", "All heap blocks were freed -- no leaks are possible"])
